...
| **L05** | 调试工具与环境        | 4h    | ⭐⭐☆☆☆   | pdb、breakpoint()、traceback、sys.last_traceback | ✅   |
| **L06** | 异常处理与防御代码     | 6h    | ⭐⭐☆☆☆   | try/except/finally/else、raise、自定义异常      | ✅   |
| **L07** | 面向对象基础           | 6h    | ⭐⭐☆☆☆   | 类、对象、继承、多态、封装、组合              | ✅   |
| **L08** | 魔术方法与协议         | 4h    | ⭐⭐⭐☆☆  | \__init\_\_、\__str\_\_、\__repr\_\_、\__len\_\_ 等 | ✅   |
| **L09** | 文件操作与上下文管理    | 8h    | ⭐⭐☆☆☆   | 文件读写、with 语句、路径操作、JSON/CSV       | ✅   |
| **P01** | 综合实战：学员管理系统  | 6-8h  | ⭐⭐⭐☆☆  | 综合项目：命令行学员管理系统                  | ✅   |
...
L01 (6h)  →  L02 (6h)  →  L03 (8h)
    ↓
L04 (8h)  →  L05 (4h)  →  L06 (6h)
    ↓
L07 (6h)  →  L08 (4h)  →  L09 (8h)
    ↓
P01 综合实战（6-8h）
    ↓
Stage 1
...
Week 2: L04 → L06 (18h)  + 练习 (10h)
Week 3: L07 → L09 (18h)  + 练习 (10h)
Week 4: P01 综合项目 (8h) + 复习 (6h)
```
...
**Q: 完成 Stage 0 后应该做什么？**
A: 完成综合项目（P01），通过毕业测试，然后进入 Stage 1。
...
**下一步**: 完成 P01 综合项目后，进入 [Stage 1 - Python 进阶](../stage1-python-intermediate/README.md)
