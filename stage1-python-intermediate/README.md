...
| **P02** | 数据处理管道系统       | 8-10h | ⭐⭐⭐⭐  | 综合项目：类型系统+生成器+装饰器+异步       | ✅   |

**总计**: 10 课程（9 课 + 1 项目）| ~55 小时
...
Week 6: P02 数据处理管道项目 (8h)
Week 7: Stage 1 复习 (4h) + 进入 Stage 2 准备 (4h)
```
...
Week 9: L16 并发编程入门
Week 10: L17 函数式编程
Week 11: L18 正则 + 函数式复习
Week 12-13: P02 数据处理管道项目
Week 14: Stage 1 复习 + Stage 2 准备
```
