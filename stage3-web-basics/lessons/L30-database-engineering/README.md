...
```bash
cd stage3-web-basics/lessons/L30-database-engineering
uv sync
...
- [L31: SQL 进阶 - 高级特性与性能优化](../L31-sql-advanced/README.md)

> 📖 **学习路径提示**：L31 将学习窗口函数、CTE 查询和查询优化。
