...
L32 SSE 服务器推送事件 - FastAPI SSE 路由
====================================
...
if __name__ == "__main__":
    print("=" * 80)
    print("L32 SSE 服务器推送事件 - FastAPI SSE 路由")
    print("=" * 80 + "\n")
