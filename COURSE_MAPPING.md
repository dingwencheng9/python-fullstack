...
> **受众**: 所有学习者、课程维护者
> **更新频率**: 低（课程编号变化时更新）
> **最后更新**: 2026-08-16（v2.4: 修正课程总数 123 节（含 6 个收官项目），更新 Stage A/S/K/M/R 状态为完整）
...
| Stage 2 | 现代工程 | L19-L26 | 9 | L19-L26 | — | ✅ 完整 |
| Stage 3 | Web 开发基础 | L27-L35 | 10 | L27-L35 | — | ✅ 完整 |
...
| Stage | 名称 | 课程范围 | 课程数 | CORE | ELECTIVE | 状态 |
|-------|------|----------|--------|------|----------|------|
| Stage A | AI Agent 企业级 | A01-A20 | 20 | A01-A05 | A06-A20 | ✅ 完整 |
| Stage S | Python 爬虫专精 | S01-S09 | 9 | S01-S09 | — | ✅ 完整 |
| Stage K | DevOps 与平台工程 | K01-K05 | 5 | K01-K05 | — | ✅ 完整 |
| Stage M | 企业级 AI 应用 | M01-M08 | 8 | M01-M08 | — | ✅ 完整 |
| Stage R | 前沿探索实验室 | R01-R10 | 10 | R01-R10 | — | ✅ 完整 |

**总计**: 11 个 Stage · 123 节课程（含 6 个收官项目 P01-P06）
**通用核心**: 72 节课（L01-L65 + P01-P06）
**垂直专精**: 51 节（S:9 + K:5 + M:8 + R:10 + A:20）
**建议总学时**: ~680 小时
